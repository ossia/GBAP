...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 234.0, 425.5, 365.0, 33.0 ],
									"text" : "each MBAP is fed with a list of weights, and the systemNumber: value defines the index in this list, and applies a gain to the output"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 232.0, 321.5, 30.0, 47.0 ],
									"text" : "  |\n v"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 17.5, 812.0, 770.0, 106.0 ],
									"setminmax" : [ 0.0, 1.0 ],
									"setstyle" : 1,
									"size" : 14
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 17.5, 717.0, 762.0, 76.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 43.0, 600.0, 120.0, 62.0 ],
									"text" : "systemNumber 1, numSinks 7 2, cursorSize 0.05 0.2, sinkSize 0.1 0.3"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 47.0, 559.0, 100.0, 22.0 ],
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 815.0, 522.0, 116.0, 400.0 ],
									"setminmax" : [ 0.0, 1.0 ],
									"setstyle" : 1,
									"size" : 18
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 815.0, 121.0, 106.0, 49.0 ],
									"text" : "systemNumber 3, numSinks 2 9, cursorSize 0.1 0.1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 815.0, 91.0, 58.0, 22.0 ],
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 815.0, 189.0, 116.0, 314.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 609.5, 425.5, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 668.0, 425.5, 106.0, 22.0 ],
									"text" : "systemNumber $1"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 220.0, 624.0, 556.0, 78.0 ],
									"setminmax" : [ 0.0, 1.0 ],
									"setstyle" : 1,
									"size" : 9
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 220.0, 531.0, 556.0, 78.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 242.5, 495.0, 380.0, 22.0 ],
									"text" : "systemNumber 2, numSinks 3 3, cursorSize 0.1 0.15, sinkSize 0.1 0.1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 648.5, 495.0, 100.0, 22.0 ],
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 234.0, 369.0, 335.0, 47.0 ],
									"text" : "this can be used to distribute sound across several MBAP systems:"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 29.0, 12.0, 743.0, 27.0 ],
									"text" : "MBAPs can also be in one dimension, e.g. for panning across several speakers in line"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 1,
									"patching_rect" : [ 500.0, 41.0, 50.0, 22.0 ],
									"saved_attribute_attributes" : 									{
										"valueof" : 										{
											"parameter_initial" : [ 6 ],
											"parameter_initial_enable" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 500.0, 71.0, 77.0, 22.0 ],
									"text" : "rollOff $1"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 411.0, 41.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 411.0, 71.0, 77.0, 22.0 ],
									"text" : "normalize $1"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 110.0, 118.0, 77.0, 308.0 ],
									"setminmax" : [ 0.0, 1.0 ],
									"setstyle" : 1,
									"size" : 4
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 29.0, 71.0, 105.0, 35.0 ],
									"text" : "numSinks 1 4, cursorSize 1 0.1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 29.0, 41.0, 58.0, 22.0 ],
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 29.0, 118.0, 58.0, 308.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 234.0, 198.0, 540.0, 125.0 ],
									"setminmax" : [ 0.0, 1.0 ],
									"setstyle" : 1,
									"size" : 3
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 218.0, 71.0, 178.0, 22.0 ],
									"text" : "numSinks 3 1, cursorSize 0.1 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 218.0, 41.0, 58.0, 22.0 ],
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 218.0, 103.0, 556.0, 78.0 ]
								}
...
, 							{
								"box" : 								{
									"angle" : 270.0,
									"bgcolor" : [ 0.333333333333333, 0.290196078431373, 0.262745098039216, 1.0 ],
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 224.0, 362.0, 573.0, 99.0 ],
									"proportion" : 0.39
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 797.0, 71.0, 145.0, 861.0 ],
									"proportion" : 0.39
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 13.5, 461.0, 790.0, 471.0 ],
									"proportion" : 0.39
								}
						...
						"lines" : [ 							{
								"patchline" : 								{
									...
									"midpoints" : [ 227.5, 465.0, 801.0, 465.0, 801.0, 184.0, 824.5, 184.0 ],
									"order" : 0,
									"source" : [ "obj-1", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 227.5, 463.0, 27.0, 463.0 ],
									"order" : 3,
									"source" : [ "obj-1", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 38.5, 443.0, 99.0, 443.0, 99.0, 107.0, 119.5, 107.0 ],
									"source" : [ "obj-19", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-1", 0 ],
									"midpoints" : [ 420.5, 97.5, 227.5, 97.5 ],
									"source" : [ "obj-20", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-26", 0 ],
									"midpoints" : [ 677.5, 483.5, 229.5, 483.5 ],
									"source" : [ "obj-27", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-15", 0 ],
									"midpoints" : [ 52.5, 676.0, 27.0, 676.0 ],
									"source" : [ "obj-28", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 619.0, 457.5, 665.5, 457.5, 665.5, 414.5, 677.5, 414.5 ],
									"source" : [ "obj-29", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-1", 0 ],
									"midpoints" : [ 509.5, 97.5, 227.5, 97.5 ],
									"source" : [ "obj-7", 0 ]
								}
...
,
					"patching_rect" : [ 64.0, 846.0, 493.0, 49.0 ],
...
,
					"text" : "p linear_&_cascading_MBAPs"
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-12::obj-9" : [ "number[10]", "number[9]", 0 ],
